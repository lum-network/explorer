...
const data = [
    ...
    { time: 1655722800, value: 4 },
    { time: 1655726400, value: 6 },
    { time: 1655730000, value: 8 },
    { time: 1655733600, value: 10 },
    { time: 1655737200, value: 12 },
    { time: 1655740800, value: 14 },
    { time: 1655744400, value: 16 },
    { time: 1655748000, value: 18 },
    { time: 1655751600, value: 22 },
    { time: 1655755200, value: 26 },
    { time: 1655758800, value: 28 },
    { time: 1655762400, value: 32 },
    { time: 1655766000, value: 38 },
    { time: 1655769600, value: 44 },
    { time: 1655773200, value: 50 },
...
const RatingsChart = (): JSX.Element => {
    ...
    return (
        <div className="col-12 col-xxl-6 mb-4 mb-xxl-5">
            <Card withoutPadding className="p-4">
                <h1 className="mb-4">{i18n.t('ratingsNumbers')}</h1>
